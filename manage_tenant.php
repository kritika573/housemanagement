...
<div class="container-fluid">
	<form action="" id="manage-tenant" name="myform">
...
<script>
		...
		var amount=document.myform.firstname.value;
		...
		if (lastname.length === 0){
            document.getElementById("lastname").innerHTML="Please Enter Name";
            document.getElementById("lastname").style.color="Red";
			flag=false;
		}
		if (firstname.length === 0){
            document.getElementById("firstname").innerHTML="Please Enter Name";
            document.getElementById("firstname").style.color="Red";
			flag=false;
		}
		if(isNaN(contact)){
            document.getElementById("contact").innerHTML="Enter only number";
