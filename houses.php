...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<!-- FORM Panel -->
			<div class="col-md-4">
			<form action="" id="manage-house" name="myform">
				<div class="card">
...
<script>
	  ...
	  function validation(){
			...
			var house_no=document.myform.house_no.value;
			var price=document.myform.price.value;

			document.getElementById('house_no').innerHTML ="";
			...
			if (house_no.length === 0){
				document.getElementById("house_no").innerHTML="Please Enter house_no";
				document.getElementById("house_no").style.color="Red";
				flag=false;
			}
			if(isNaN(price) || price < 100 || price > 100000){
				document.getElementById("price").innerHTML="price must be Valid ";
