...
<div class="container-fluid">
    <form action="" id="manage-payment" name="myform">
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
        <div id="msg"></div>
        <div class="form-group">
            <label for="" class="control-label">Flat Owner</label>
...
<script>
		...
		var invoice=document.myform.invoice.value;
		...
		if(invoice === undefined){
			document.getElementById('invoice').innerHTML ="** Please Enter Invoice number ";
			flag=false;
		} else if(isNaN(invoice)){
            document.getElementById("invoice").innerHTML="Enter only invoice";
