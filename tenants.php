		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> New Flat Owner
				</a></span>
					</div>
					<div class="card-body">
...
<script>
	...
	$('#new_tenant').click(function(){
		uni_modal(" ","manage_tenant.php","mid-large")
		
	})

	$('.view_payment').click(function(){
		uni_modal("Flat Owners Payments","view_payment.php?id="+$(this).attr('data-id'),"large")
		
	})
	$('.edit_tenant').click(function(){
		uni_modal("Manage Tenant Details","manage_tenant.php?id="+$(this).attr('data-id'),"large")
